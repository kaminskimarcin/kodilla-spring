...
public class CrudAppTestSuite {
    private static final String BASE_URL ="https://kaminskimarcin.github.io/";
    ...
    private boolean checkTaskExistsInTrello(String taskName) throws InterruptedException {
        ...
        driverTrello.findElement(By.id("user")).sendKeys("kaminski283@gmail.com");
        driverTrello.findElement(By.id("password")).sendKeys("TESTOWE15");
